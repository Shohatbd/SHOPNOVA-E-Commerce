...
const defaultSettings: Partial<SiteSettings> = {
  site_name: 'SHOPNOVA',
  site_tagline_en: 'Premium Lifestyle & Modern Gadget Destination',
  site_tagline_bn: 'প্রিমিয়াম লাইফস্টাইল ও আধুনিক গ্যাজেটের বিশ্বস্ত ঠিকানা',
  currency: 'BDT',
  currency_symbol: '৳',
  contact_phone: '+880 1700-000000',
  contact_email: 'support@shopnova.com',
  announcement_enabled: 'true',
  announcement_en: '⚡ Festive Special: Free Home Delivery on orders above ৳2,500! Use code NOVA20 ⚡',
  announcement_bn: '⚡ বিশেষ অফার: ২৫০০ টাকার বেশি অর্ডারে ফ্রি হোম ডেলিভারি! কোড NOVA20 ব্যবহার করুন ⚡',
  ...
  contact_whatsapp: 'https://wa.me/8801700000000',
  facebook_url: 'https://facebook.com/shopnovabd',
  instagram_url: 'https://instagram.com/shopnovabd',
  youtube_url: 'https://youtube.com/@shopnovabd',
