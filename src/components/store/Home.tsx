  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        {banners.length > 0 ? (
          <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl aspect-[14/9] sm:aspect-[18/9] lg:aspect-[24/9] min-h-[220px] sm:min-h-[290px] md:min-h-[360px] lg:min-h-[440px] max-h-[520px] bg-slate-900">
            {banners.map((banner, index) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t sm:bg-gradient-to-r from-slate-950/95 via-slate-950/65 sm:via-slate-950/50 to-transparent flex items-end sm:items-center">
                    <div className="max-w-xl p-4 sm:p-8 md:p-12 space-y-1.5 sm:space-y-3 md:space-y-4">
                      {displayBadge && (
                      ...
                      <h1 className="text-lg sm:text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight font-siliguri">
                        {displayTitle}
                      </h1>

                      {displaySubtitle && (
                        <p className="text-[11px] sm:text-sm md:text-base text-slate-300 line-clamp-1 sm:line-clamp-2 md:line-clamp-3 font-siliguri max-w-xs sm:max-w-md">
                          {displaySubtitle}
                        </p>
                      )}
                      ...
                      <div className="pt-1 sm:pt-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 sm:gap-2 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold px-3.5 sm:px-6 py-1.5 sm:py-2.5 rounded-lg sm:rounded-xl shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 transition-all text-xs sm:text-sm group font-siliguri"
                        >
            ...
            {banners.length > 1 && (
              <>
                <button
                  ...
                  className="hidden sm:flex absolute left-4 top-1/2 -translate-y-1/2 z-20 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-black/40 hover:bg-black/70 text-white items-center justify-center backdrop-blur-md transition-colors"
                ...
                <button
                  ...
                  className="hidden sm:flex absolute right-4 top-1/2 -translate-y-1/2 z-20 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-black/40 hover:bg-black/70 text-white items-center justify-center backdrop-blur-md transition-colors"
                  ...
                  {banners.map((_, i) => (
                    <button
                      ...
                      className={`h-1.5 sm:h-2 rounded-full transition-all ${
                        i === currentSlide ? 'w-6 sm:w-8 bg-amber-500' : 'w-1.5 sm:w-2 bg-white/50 hover:bg-white/80'
                      }`}
                    />
                  ))}
                </div>
