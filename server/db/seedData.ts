...
export const seedSettings = [
  { key: 'site_name', value: 'SHOPNOVA' },
  { key: 'site_tagline_en', value: 'Premium Lifestyle & Modern Gadget Destination' },
  { key: 'site_tagline_bn', value: 'প্রিমিয়াম লাইফস্টাইল ও আধুনিক গ্যাজেটের বিশ্বস্ত ঠিকানা' },
  { key: 'currency', value: 'BDT' },
  { key: 'currency_symbol', value: '৳' },
  { key: 'contact_phone', value: '+880 1700-000000' },
  { key: 'contact_email', value: 'support@shopnova.com' },
  { key: 'company_address_en', value: 'House 45, Road 11, Block D, Banani, Dhaka-1213, Bangladesh' },
  { key: 'company_address_bn', value: 'বাড়ি ৪৫, রোড ১১, ব্লক ডি, বনানী, ঢাকা-১২১৩, বাংলাদেশ' },
  { key: 'announcement_en', value: '⚡ Festive Special: Free Home Delivery on orders above ৳2,500! Use code NOVA20 ⚡' },
  { key: 'announcement_bn', value: '⚡ বিশেষ অফার: ২৫০০ টাকার বেশি অর্ডারে ফ্রি হোম ডেলিভারি! কোড NOVA20 ব্যবহার করুন ⚡' },
  { key: 'facebook_url', value: 'https://facebook.com/shopnovabd' },
  { key: 'instagram_url', value: 'https://instagram.com/shopnovabd' },
  { key: 'youtube_url', value: 'https://youtube.com/@shopnovabd' },
  { key: 'contact_whatsapp', value: 'https://wa.me/8801700000000' },
  {
